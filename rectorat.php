...
<html lang="fr">
    <head>
        ...
        <title>Hugo Pidoux | Rectorat</title>
        <link rel="stylesheet" href="./main.css" />
    </head>
    <body>

        <?php include './header.php'; ?>
        <section class="rectorat">
            <h2>Rectorat</h2>
            ...
            <div class="doc-cards-container">
                ...
                <a href="./public/doc/HPI_CertificatScolarite1.pdf" download class="doc-download-card">
                    <img
                ...
                <a href="./public/doc/HPI_CertificatScolarite2.pdf" download class="doc-download-card">
                    <img
                        src="./public/images/logo_campus_la_chataigneraie.png"
                        alt="chatos"
                    />
                    <p>HPI_CertificatScolarite2.pdf</p>
                </a>
                ...
                <a href="./public/doc/HPI_AttestationStage2.pdf" download class="doc-download-card">
                    <img
                        src="./public/images/stage.png"
                        alt="chatos"
                    />
